...
class CategoryDessertActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_category_dessert2)
        ...
        val categoryName = intent.getStringExtra("Dessert") ?: "Dessert"
        title.text = "Dessert"
    ...
    private fun loadRecipesByCategory(category: String) {
        database.orderByChild("category").equalTo("Dessert")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (snapshot.exists()) {
                        ...
                        Toast.makeText(this@CategoryDessertActivity2, "No recipes found in this category", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@CategoryDessertActivity2, "Failed to load recipes", Toast.LENGTH_SHORT).show()
                }
            })
    }
