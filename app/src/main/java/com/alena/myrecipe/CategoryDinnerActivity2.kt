...
class CategoryDinnerActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_category_dinner2)
        ...
        val categoryName = intent.getStringExtra("Dinner") ?: "Dinner"
        title.text = "Dinner"
    ...
    private fun loadRecipesByCategory(category: String) {
        database.orderByChild("category").equalTo("Dinner")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (snapshot.exists()) {
                        ...
                        Toast.makeText(this@CategoryDinnerActivity2, "No recipes found in this category", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@CategoryDinnerActivity2, "Failed to load recipes", Toast.LENGTH_SHORT).show()
                }
            })
    }
