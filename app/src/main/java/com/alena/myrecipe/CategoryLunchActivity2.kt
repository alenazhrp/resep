...
class CategoryLunchActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_category_lunch2)
        ...
        val categoryName = intent.getStringExtra("Lunch") ?: "Lunch"
        title.text = "Lunch"
    ...
    private fun loadRecipesByCategory(category: String) {
        database.orderByChild("category").equalTo("Lunch")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (snapshot.exists()) {
                        ...
                        Toast.makeText(this@CategoryLunchActivity2, "No recipes found in this category", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onCancelled(error: DatabaseError) {
                    Toast.makeText(this@CategoryLunchActivity2, "Failed to load recipes", Toast.LENGTH_SHORT).show()
                }
            })
    }
